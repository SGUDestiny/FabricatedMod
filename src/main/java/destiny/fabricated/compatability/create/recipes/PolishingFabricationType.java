...
public class PolishingFabricationType extends FabricationType<SandPaperPolishingRecipe>
{

    @Override
    public List<Fabrication> assembleFabrications(FabricatorContainer container, SandPaperPolishingRecipe recipe,
