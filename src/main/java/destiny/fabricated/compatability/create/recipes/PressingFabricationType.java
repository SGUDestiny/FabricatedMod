...
public class PressingFabricationType extends FabricationType<PressingRecipe>
{

    @Override
    public List<Fabrication> assembleFabrications(FabricatorContainer container, PressingRecipe recipe,
